...
K = Realizable_Set.get_instance((2,3,4))
K.get_realizations() # returns a `list` of 5 x 5 matrices. There should be exactly 4 matrices.
K.get_blocks() # returns a `list` of 3 x 3 matrices. There should be exactly 2 matrices.

K = Realizable_Set.get_instance((3,4,5,6,7))
K.get_realizations() # returns a `list` of 8 x 8 matrices. There should be exactly 36 matrices.
K.get_blocks() # returns a `list` of 5 x 5 matrices. There should be exactly 6 matrices.

K = Realizable_Set.get_instance((1,4))
K.get_realizations() # returns a `list` of 5 x 5 matrices. There should be exactly 8 matrices.

K = Realizable_Set.get_instance((3,4,5,6))
K.get_realizations() # returns a `list` of 7 x 7 matrices. There should be exactly 60 matrices.

K = Realizable_Set.get_instance((3,))
K.get_realizations() # returns a `list` of 4 x 4 matrices. There should be exactly 3 matrices.
